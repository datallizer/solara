...
<head>
    ...
    <title>T. Mecánicos Asignados para Ensamble | Solara</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>TÉCNICOS MECÁNICOS ASIGNADOS PARA ENSAMBLE <button type="button" class="btn btn-primary btn-sm float-end m-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        Asignar T. Mecánico
                                    </button></h4>
                            </div>
                                ...
                                <table id="miTabla" class="table table-bordered table-striped" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Proyecto</th>
                                            <th>Técnico mecanico asignado</th>
                                            <th>Accion</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="codencargados.php" method="POST" class="d-inline">
                                                            <button type="submit" name="delete" value="<?= $registro['id_encargado']; ?>" class="btn btn-danger btn-sm m-1"><i class="bi bi-trash-fill"></i></button>
                                                        </form>
                                                    </td>
                                                </tr>
                                        <?php
