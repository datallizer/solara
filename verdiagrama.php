...
if (isset($_SESSION['codigo'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $queryubicacion = "UPDATE `usuarios` SET `ubicacion` = 'Visualizador de diagramas' WHERE `usuarios`.`codigo` = '$codigo'";
...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM diagrama WHERE id = $plano_id";
    $result = mysqli_query($con, $query);
...
?>
            ...
            <head>
                ...
                <title>Ver diagrama | Solara</title>
