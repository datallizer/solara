...
$query = "SELECT COUNT(*) as total_planos FROM diagrama WHERE estatusplano = '1'";
$result = mysqli_query($con, $query);
$row = mysqli_fetch_assoc($result);
$totals['asignados'] = $row['total_planos'];

// Total de planos en progreso
$query = "SELECT COUNT(*) as total_planos FROM diagrama WHERE estatusplano = '3'";
$result = mysqli_query($con, $query);
$row = mysqli_fetch_assoc($result);
$totals['progreso'] = $row['total_planos'];

// Total de planos pausados
$query = "SELECT COUNT(*) as total_planos FROM diagrama WHERE estatusplano = '2'";
$result = mysqli_query($con, $query);
$row = mysqli_fetch_assoc($result);
