...
<head>
    ...
    <title>Nómina personal | Solara</title>
                        ...
                        <h3 class="p-2 bg-dark text-light align-items-top" style="text-transform: uppercase;border-radius:5px;">
                            ...
                            ?>
                                    <div class="row">
                                        ...
                                        <div class="col-11">
                                            <a href="nomina.php" class="btn btn-primary btn-sm float-end">Regresar</a>
                                            <b>NÓMINA</b><br>
                                             De <b><?= $registro['nombre']; ?> <?= $registro['apellidop']; ?> <?= $registro['apellidom']; ?></b><br>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 style="text-transform: uppercase;">CALCULO POR DÍA
            ...
            fecha";
                    ...
                    <div class="col-4">
                        <div class="card bg-light p-3">
                            <h4><b>CALCULO QUINCENAL</b></h4>
                            <p>Del 0000-00-00 al 0000-00-00</p>
                            <p><b>Cuota diaria</b></p>
                            <p>$000.00</p>
                            <p><b>Deducciones</b></p>
                            <p>IVA <small>16%</small> $0000.00</p>
                            <p>ISR <small>5%</small> $000.00</p>
                            <p><b>Sueldo bruto</b></p>
                            <p>$0000.00</p>
                            <p><b>Sueldo neto</b></p>
                            <p>$0000.00</p>
                        </div>
