                                        ...
                                        <form action="codeusuarios.php" method="POST">
                                            ...
                                            <div class="row mt-1">
                                                ...
                                                <select class="form-select" name="estatus" id="estatus">
                                                    ...
                                                    <option value="1" <?= ($estatus_actual == 0) ? 'selected' : ''; ?>>Inactivo</option>
                                                    <option value="2" <?= ($estatus_actual == 1) ? 'selected' : ''; ?>>Activo</option>
                                                </select>
                                                ...
                                                <select class="form-select" name="rol" id="rol">
                                                    ...
                                                    <option value="3" <?= ($rol_actual == 4) ? 'selected' : ''; ?>>Tecnico controles</option>
                                                    <option value="3" <?= ($rol_actual == 5) ? 'selected' : ''; ?>>Ing- Diseño</option>
                                                    <option value="3" <?= ($rol_actual == 6) ? 'selected' : ''; ?>>Compras</option>
                                                    <option value="3" <?= ($rol_actual == 7) ? 'selected' : ''; ?>>Almacenista</option>
                                                    <option value="3" <?= ($rol_actual == 8) ? 'selected' : ''; ?>>Operador</option>
                                                    <option value="3" <?= ($rol_actual == 9) ? 'selected' : ''; ?>>Ing.Control</option>
                                                </select>
