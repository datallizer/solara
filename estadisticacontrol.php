...
if (isset($_SESSION['codigo'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $queryubicacion = "UPDATE `usuarios` SET `ubicacion` = 'Estadística técnico control' WHERE `usuarios`.`codigo` = '$codigo'";
        ...
        <div id="layoutSidenav_content">
            <div class="container mt-5">
                <div class="row justify-content-center align-items-center">
                            ...
                            ?>
                                    <div class="row">
                                        ...
                                        <div class="col-11">
                                            ...
                                            <b>Estadística</b><br>
                                            Ensambles de <b><?= $registro['nombre']; ?> <?= $registro['apellidop']; ?> <?= $registro['apellidom']; ?></b><br>
                    ...
                    $query = "SELECT historialensamble.*, diagrama.nombreplano 
                                                  FROM historialensamble 
                                                  INNER JOIN diagrama ON historialensamble.idplano = diagrama.id 
                                                  WHERE historialensamble.idcodigo = '$codigouser' 
                                                  AND diagrama.estatusplano = 0
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Mes</th>
                                        <th class="text-center">Ensambles finalizados</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
