...
if (isset($_SESSION['codigo'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $queryubicacion = "UPDATE `usuarios` SET `ubicacion` = 'Permisos rechazados' WHERE `usuarios`.`codigo` = '$codigo'";
...
<head>
    ...
    <title>Permisos rechazados | Solara</title>
</head>
        ...
        <div id="layoutSidenav_content">
            <div class="container-fluid">
                <div class="row justify-content-md-center justify-content-start mt-5 mb-3">
                    <div class="col-12">
                        <h2 class="mb-3">PERMISOS RECHAZADOS</h2>
                    </div>
                    ...
                    <div class="col card text-center m-1 bg-dark">
                        <a style="color: #fff;" class="p-3" href="permisos.php"><i class="bi bi-x-circle-fill" style="font-size: 30px;"></i><br>Solicitudes vigentes</a>
                    </div>
                    <?php
                            ...
                            <div class="card-body" style="overflow-y:scroll;">
                                ...
                                ?>
                                    <table id="miTabla" class="table table-bordered table-striped" style="width: 100%;">
                                        ...
                                        FROM permisos 
                                        INNER JOIN usuarios ON permisos.idcodigo = usuarios.codigo WHERE permisos.estatus = 0
